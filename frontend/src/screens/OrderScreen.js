...
import { Row, Col, Button, ListGroup, Image, Card, Alert } from "react-bootstrap";
...
const OrderScreen = () => {
  ...
  }, [dispatch, order, successPay, orderId, successDeliver, navigate, userInfo]);
  ...
  return loading ? (
    ...
    <>
      <Alert key="1" variant="success">
        <span>Order {order._id} confirmed!</span>
      </Alert>
        ...
        <Col md={8}>
          <Card>
            <ListGroup variant="flush">
              ...
              <ListGroup.Item className="mmb-3">
                <h2>Order Items</h2>
